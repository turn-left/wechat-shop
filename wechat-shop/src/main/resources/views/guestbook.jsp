...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li><a href="product-list.jsp">图书</a></li>
			<li><a href="product_list.jsp">百货</a></li>
			<li><a href="product_list.jsp">品牌</a></li>
			<li><a href="product_list.jsp">促销</a></li>
		</ul>
	</div>
</div>
<div id="childNav">
	<div class="wrap">
		<ul class="clearfix">
			<li class="first"><a href="product_list.jsp">音乐</a></li>
			<li><a href="product_list.jsp">影视</a></li>
			<li><a href="product_list.jsp">少儿</a></li>
			<li><a href="product_list.jsp">动漫</a></li>
			<li><a href="product_list.jsp">小说</a></li>
			<li><a href="product_list.jsp">外语</a></li>
			<li><a href="product_list.jsp">数码相机</a></li>
			<li><a href="product_list.jsp">笔记本</a></li>
			<li><a href="product_list.jsp">羽绒服</a></li>
			<li><a href="product_list.jsp">秋冬靴</a></li>
			<li><a href="product_list.jsp">运动鞋</a></li>
			<li><a href="product_list.jsp">美容护肤</a></li>
			<li><a href="#">饰品</a></li>
			...
			<ul>
				...
				<c:forEach var="comment" items="${list}" >
					<dl>
						...
						<dd><c:if test="${comment.EC_REPLY ==null}">
								未回复
						</c:if>
