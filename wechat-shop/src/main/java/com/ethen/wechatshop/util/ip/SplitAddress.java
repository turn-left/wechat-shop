 ...
 * 由于<code>IPEntity</code>->nation,province,city,region是作的切分,故 ipentity.getNation()
 * 等没有输入参数,调用直接输出:
 *      ipentity.getNation();
...
public class SplitAddress {
    public static void main(String[] args) {
        try {
            IPSeeker ipseeker = new IPSeeker(new File("C:\\space-work\\zcommon-files\\qqwry.dat"));
